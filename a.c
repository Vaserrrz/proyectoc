...
ENTRADA: pszNombreNodo Nombre del Nodo a Buscar en la lista de vertices
  pstListaVertices Lista de vertices donde Buscamos el nodo
DESCRIPCION :
Buscamos si en ese Lista de vertices del color esta el Nodo que
estamos evaluando
RETORNO:
SUCCESS si encuentra el nodo
ERROR Si nunca lo encontro
***********************************************************************/
...
AUTOR: SANTIAGO RIVERA
FUNCION:
ENTRADA: pstLitaNodos LIsta de nodos que le pertenece a un color
  pstListaVertices Lista de vertices donde Buscamos el cada uno de los nodo
DESCRIPCION :
Buscamos si en ese Lista de vertices del color estan los nodos que ya tienen color
RETORNO:
SUCCESS si encuentra alguno de los  nodos en la lista
ERROR Si nunca lo encontro
***********************************************************************/
...
/**********************************************************************
AUTOR: SANTIAGO RIVERA
ENTRADA: sCont es la posicion en el Vector de Colores
   pstNodo puntero al nodo que se va a gregar
DESCRIPCION :
En la posicion indicada por sCont adiciona el nodo a la lista del color
y  toda la lista de vertices se agregan a los Colores
RETORNA:
***********************************************************************/
...
AUTOR: SANTIAGO RIVERA
ENTRADA:
DESCRIPCION : IMPRIME LA INFORMACION DEL GRAFO, LEIDA DESDE EL ARCHIVO
DE CONFIGURACION, recorriendo por la lista de cada grafo he imprimendo sus vertices
RETORNA:
***********************************************************************/
short vMostrar(void)
{
